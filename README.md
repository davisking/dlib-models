...
For more information and additional resources related to this model (including the checkpoint file that can be used for fine-tuning the model if required), please visit [our GitHub repository](https://github.com/Cydral/FFgan).
